const FilterOptions = () => {
  return (
    <div className="text-white flex z-50 items-center bg-[[#191b1a]] bg-opacity-90 sticky top-0 py-4 backdrop-blur border-t border-[#242627] ">
      <div className="max-w-3xl mx-auto overflow-x-scroll scrollbar-hide flex  items-center">
        <div className="overflow-x-scroll scrollbar-hide flex  items-center px-3 md:px-0">
          {/* Top */}
          <button>
            <div className="flex items-center mr-8 bg-[#13343b] py-1 px-2 rounded-lg">
              <svg
                aria-hidden="true"
                focusable="false"
                data-prefix="far"
                data-icon="star"
                className="svg-inline--fa fa-star fa-sm -translate-y-px delay-200 text-super w-5 mr-1 text-[#1fb8ce]"
                role="img"
              ...
              <p className="text-[#1fb8ce]">Top</p>
            </div>
          </button>

          {/* Tech and science */}
          <button className=" hover:text-[#8d9192]">
            <div className="flex items-center mr-8  hover:text-[#8d9192]">
              <svg
                aria-hidden="true"
                focusable="false"
                data-prefix="far"
                data-icon="microchip-ai"
                className="svg-inline--fa fa-microchip-ai fa-sm -translate-y-px delay-200 text-text w-5 mr-1"
                role="img"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
              >
              ...
              <p className="whitespace-nowrap">Tech & Science</p>
            </div>
          </button>
          ...
          <button className=" hover:text-[#8d9192]">
            <div className="flex items-center mr-8">
              <svg
                ...
                className="svg-inline--fa fa-circle-dollar fa-sm -translate-y-px delay-200 text-text w-5 mr-1"
                role="img"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
              >
          ...
          <button className=" hover:text-[#8d9192]">
            <div className="flex items-center mr-8">
              <svg
                ...
                data-prefix="far"
                data-icon="palette"
                className="svg-inline--fa fa-palette fa-sm -translate-y-px delay-200 text-super w-5 mr-1"
                role="img"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
              >
              ...
              <p className="whitespace-nowrap">Arts & Culture</p>
            </div>
          </button>
          ...
          <button className=" hover:text-[#8d9192]">
            <div className="flex items-center mr-8">
              <svg
                ...
                data-prefix="far"
                data-icon="medal"
                className="svg-inline--fa fa-medal fa-sm -translate-y-px delay-200 text-text w-5 mr-1"
                role="img"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
              >
          ...
          <button className=" hover:text-[#8d9192]">
            <div className="flex items-center mr-4">
              <svg
                ...
                data-prefix="far"
                data-icon="tv"
                className="svg-inline--fa fa-tv fa-sm -translate-y-px delay-200 text-text w-5 mr-1 "
                role="img"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 640 512"
              >
        ...
        <div className="hidden md:block mx-3">
          <svg
            ...
            data-prefix="far"
            data-icon="sliders"
            className="svg-inline--fa fa-sliders fa-fw fa-1x w-4 h-4"
            role="img"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
          >
