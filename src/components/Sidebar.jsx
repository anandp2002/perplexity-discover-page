      ...
      >
        <div className="flex justify-between items-center p-4">
          <svg
            ...
            className={`${expanded ? 'block' : 'hidden'} hover:cursor-pointer`}
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
        ...
        <ul className="space-y-4 p-4">
          {expanded ? (
            <input
              ...
              } bg-[#191b1a] p-2 rounded-full pl-4 relative`}
            />
          ) : (
            <svg
              aria-hidden="true"
              ...
              data-prefix="far"
              data-icon="plus"
              class="svg-inline--fa fa-plus fa-fw fa-lg "
              role="img"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512"
              className={`h-[16px] mt-2 ${expanded ? 'h-[16px]' : 'pl-1'}`}
            >
              <path
                fill="currentColor"
          ...
          {/* Home */}
          <div className="flex items-center text-[#8d9192] hover:text-white cursor-pointer">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fak"
              ...
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
              className={`h-6 mt-2 ${expanded ? ' h-5' : 'pl-1'} `}
            >
              <path
                fill="currentColor"
            ...
            <span
              className={`pl-2 ml-1 mt-2 text-lg ${
                expanded ? 'block' : 'hidden'
              }`}
            >
              Home
          ...
          <div
            ...
            className="flex items-center text-[#8d9192] hover:text-white cursor-pointer"
          >
            <svg
              aria-hidden="true"
              focusable="false"
              ...
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 640 512"
              className={`h-6 mt-2 ${expanded ? 'h-[16px]' : 'pl-1'} `}
            >
              <path
                fill="currentColor"
          ...
          <div>
            <button
              className={`text-black bg-[#20b8cd] px-4 py-2 rounded-full w-40 font-semibold mt-2 ${
