const Heading = () => {
  return (
    <div className="flex bg-[#566366] text-white items-center justify-between md:mt-1 pl-1 md:mr-1 md:ml-1 md:border border-[#181a1c] md:rounded-lg py-4 md:pl-56">
      <div className="flex items-center">
        ...
        <h1 className="text-3xl pl-1">Discover</h1>
      </div>
      <div className="mr-4">
        <svg
          aria-hidden="true"
          ...
          data-prefix="far"
          data-icon="sliders"
          className="svg-inline--fa fa-sliders fa-fw fa-1x w-6 h-6"
          role="img"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
        >
